...
import menü1 from '../img/menüler-img/burgerler/cheeseburger.jpg';
import menü2 from '../img/menüler-img/burgerler/dana-kaburga-burger.jpg';
import menü3 from '../img/menüler-img/burgerler/hamburger.jpg';
import menü4 from '../img/menüler-img/burgerler/izgara-burger.jpg';
import menü5 from '../img/menüler-img/burgerler/karamelize-soganli-burger.jpg';
import menü6 from '../img/menüler-img/burgerler/mantarli-kasarli-burger.jpg';
import burgerbg from '../img/menüler-img/burgerler/burger-orta.png';
...
const Burger = () => {
  ...
  return (
    <div className="container-fluid top-0 bottom-0 menuler">      
      <div className="container mt-5 pt-5">        
        <div className="row mt-3">          
                ...
                <div class="row align-items-center g-0">
                  <div class="col-12 col-lg-9">
                    <div class="card-body">
                      ...
                      <p class="card-text"><small class="">Hamburger Eti, 3.75 inç ekmek, Peynir, Turşu, Ketçap, Hardal.</small></p>
                    </div>
                  </div>
            ...
            <a href="">
              <div class="card mb-3 anime-left ani3" style={{maxwidth: "540px"}}>
                <div class="row align-items-center g-0 ">                
                  <div class="col-12 col-lg-9">
                    <div class="card-body">
                      <h5 class="card-title">PLANT BASED WHOPPER</h5>
                      <p class="card-text"><small class="">Whopper Eti, 5 inç ekmek, Mayonez, Marul, Peynir, Barbekü Sos, Tuz-Biber Karışımı, Soğan Halkası.</small></p>
                    </div>
                  </div>
                  <div class="col-12 col-lg-3 card-left ">                 
                ...
                <div class="row align-items-center g-0">                
                  <div class="col-12 col-lg-9">
                    <div class="card-body">
                      ...
                      <p class="card-text"><small class="">Whopper Eti, 5 inç ekmek, Mayonez, Marul, Domates, Turşu, Ketçap, Soğan, Tuz-Biber.</small></p>
                    </div>
                  </div>
                  <div class="col-12 col-lg-3 card-left ">
          ...
          <div className="col-4 mb-3 p-0 d-none d-lg-block orta anime-bottom">            
            <img className='img-fluid' src={burgerbg} alt="" />           
          </div>
                ...
                <div class="row align-items-center g-0">
                  ...
                  <div class="col-12 col-lg-9 order-0 order-lg-1">
                    <div class="card-body">
                      ...
                      <p class="card-text"><small class="">Steakburger Eti, 4.5 inç ekmek, Mayonez, Marul, Domates, Peynir, Çıtır Soğan, Steak Sos.</small></p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <a href="">
              <div class="card mb-3 anime-right ani4" style={{maxwidth: "540px"}}>
                <div class="row align-items-center g-0">
                  ...
                  <div class="col-12 col-lg-9 order-0 order-lg-1">
                    <div class="card-body">
                      <h5 class="card-title">KÖFTE BURGER</h5>
                      <p class="card-text"><small class="">Köfteburger Eti, 3.75 inç ekmek, Mayonez, Marul, Ketçap, Turşu.</small></p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <a href="">
              <div class="card mb-3 anime-right ani6" style={{maxwidth: "540px"}}>
                <div class="row align-items-center g-0">
                  ...
                  <div class="col-12 col-lg-9 order-0 order-lg-1">
                    <div class="card-body">
                      <h5 class="card-title">BRIOCHE BURGER</h5>
                      <p class="card-text"><small class="">Gurme Kuzu Eti, 4.5 inç ekmek, Mayonez, Marul, Peynir, Barbekü Sos.</small></p>
                    </div>
                  </div>
                </div>
              </div>
